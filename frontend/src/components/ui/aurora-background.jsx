    ...
    <main>
      ...
      >
        <div className="absolute inset-0 overflow-hidden">
          <div
            //   I'm using a lot of colors here to make it look special, hope you like it!
            className={cn(
              `
            ...
            [--aurora:repeating-linear-gradient(100deg,#10b981_10%,#3b82f6_15%,#6366f1_20%,#8b5cf6_25%,#3b82f6_30%)]
